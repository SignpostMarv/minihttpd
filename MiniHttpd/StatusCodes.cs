...
{
    /// <summary>
    /// Provides a collection of response codes and their corresponding English _descriptions.
    /// </summary>
    public class StatusCodes
    {
        private static readonly Hashtable _descriptions = InitDescriptions();
        ...
        public static string GetDescription(string codeNum)
        {
            return _descriptions[codeNum] as string;
        }
    }
}
